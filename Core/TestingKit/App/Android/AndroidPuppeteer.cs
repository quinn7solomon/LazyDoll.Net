...
namespace Core.TestingKit.App.Android
{
    ...
    public class AndroidPuppeteer
    {
        ...
        private AndroidEntitySystem UniqueAndroidEntitySystem = null;

        /// <summary> 单例屏幕组件对象 </summary>
        private AndroidEntityView UniqueAndroidEntityView = null;
        ...
        {
            if (UniqueAndroidEntitySystem == null)
            {
                try
                {
                    UniqueAndroidEntitySystem = new AndroidEntitySystem(AndroidDriver);
                }
            ...
            return UniqueAndroidEntitySystem;
        }
        ...
        {
            if (UniqueAndroidEntityView == null)
            {
                try
                {
                    UniqueAndroidEntityView = new AndroidEntityView(AndroidDriver);
                }
            ...
            return UniqueAndroidEntityView;
        }
